...
func WithAuthentication[N authentication.Ctx](ctx context.Context, initHandler authentication.HandlerInitializer[N]) Option[N, authorization.Ctx] {
	return func(z *Zitadel[N, authorization.Ctx]) (err error) {
		z.Authentication, err = authentication.New(ctx, z.Domain, initHandler)
		return err
	}
}
