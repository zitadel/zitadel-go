...
func (x *ObjectDetails) GetCreationDate() *timestamp.Timestamp {
	if x != nil {
...
func (x *ObjectDetails) GetChangeDate() *timestamp.Timestamp {
	if x != nil {
		return x.ChangeDate
	}
	return nil
...
type ListDetails struct {
	...
	ViewTimestamp     *timestamp.Timestamp `protobuf:"bytes,3,opt,name=view_timestamp,json=viewTimestamp,proto3" json:"view_timestamp,omitempty"`
}
...
func (x *ListDetails) GetViewTimestamp() *timestamp.Timestamp {
	if x != nil {
