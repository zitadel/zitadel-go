...
func (x *AddMyPasswordlessLinkResponse) GetExpiration() *duration.Duration {
	if x != nil {
		return x.Expiration
	}
	return nil
...
var file_zitadel_auth_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x65, 0x64, 0x42, 0xf9, 0x02, 0x5a, 0x25, 0x67, 0x69, 0x74,
	...
	0x74, 0x68, 0x92, 0x41, 0xce, 0x02, 0x12, 0x80, 0x02, 0x0a, 0x1b, 0x41, 0x75, 0x74, 0x68, 0x65,
...
var file_zitadel_auth_proto_goTypes = []interface{}{
	...
	(*duration.Duration)(nil),                     // 123: google.protobuf.Duration
