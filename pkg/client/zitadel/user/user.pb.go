...
var file_zitadel_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x97, 0x02, 0x0a, 0x0a, 0x41, 0x75, 0x74,
	...
	0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x50, 0x0a, 0x03, 0x6f, 0x74, 0x70, 0x18, 0x02, 0x20,
	...
	,
...
var file_zitadel_user_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
var file_zitadel_user_proto_goTypes = []interface{}{
	...
	(*AuthFactorU2F)(nil),                // 26: zitadel.user.v1.AuthFactorU2F
	(*WebAuthNKey)(nil),                  // 27: zitadel.user.v1.WebAuthNKey
	(*WebAuthNVerification)(nil),         // 28: zitadel.user.v1.WebAuthNVerification
	(*WebAuthNToken)(nil),                // 29: zitadel.user.v1.WebAuthNToken
	(*Membership)(nil),                   // 30: zitadel.user.v1.Membership
	(*MembershipQuery)(nil),              // 31: zitadel.user.v1.MembershipQuery
	(*MembershipOrgQuery)(nil),           // 32: zitadel.user.v1.MembershipOrgQuery
	(*MembershipProjectQuery)(nil),       // 33: zitadel.user.v1.MembershipProjectQuery
	(*MembershipProjectGrantQuery)(nil),  // 34: zitadel.user.v1.MembershipProjectGrantQuery
	(*MembershipIAMQuery)(nil),           // 35: zitadel.user.v1.MembershipIAMQuery
	(*Session)(nil),                      // 36: zitadel.user.v1.Session
	(*RefreshToken)(nil),                 // 37: zitadel.user.v1.RefreshToken
	(*PersonalAccessToken)(nil),          // 38: zitadel.user.v1.PersonalAccessToken
	(*UserGrant)(nil),                    // 39: zitadel.user.v1.UserGrant
	(*UserGrantQuery)(nil),               // 40: zitadel.user.v1.UserGrantQuery
	(*UserGrantProjectIDQuery)(nil),      // 41: zitadel.user.v1.UserGrantProjectIDQuery
	(*UserGrantUserIDQuery)(nil),         // 42: zitadel.user.v1.UserGrantUserIDQuery
	(*UserGrantWithGrantedQuery)(nil),    // 43: zitadel.user.v1.UserGrantWithGrantedQuery
	(*UserGrantRoleKeyQuery)(nil),        // 44: zitadel.user.v1.UserGrantRoleKeyQuery
	(*UserGrantProjectGrantIDQuery)(nil), // 45: zitadel.user.v1.UserGrantProjectGrantIDQuery
	(*UserGrantUserNameQuery)(nil),       // 46: zitadel.user.v1.UserGrantUserNameQuery
	(*UserGrantFirstNameQuery)(nil),      // 47: zitadel.user.v1.UserGrantFirstNameQuery
	(*UserGrantLastNameQuery)(nil),       // 48: zitadel.user.v1.UserGrantLastNameQuery
	(*UserGrantEmailQuery)(nil),          // 49: zitadel.user.v1.UserGrantEmailQuery
	(*UserGrantOrgNameQuery)(nil),        // 50: zitadel.user.v1.UserGrantOrgNameQuery
	(*UserGrantOrgDomainQuery)(nil),      // 51: zitadel.user.v1.UserGrantOrgDomainQuery
	(*UserGrantProjectNameQuery)(nil),    // 52: zitadel.user.v1.UserGrantProjectNameQuery
	(*UserGrantDisplayNameQuery)(nil),    // 53: zitadel.user.v1.UserGrantDisplayNameQuery
	(*UserGrantUserTypeQuery)(nil),       // 54: zitadel.user.v1.UserGrantUserTypeQuery
	(*object.ObjectDetails)(nil),         // 55: zitadel.v1.ObjectDetails
	(object.TextQueryMethod)(0),          // 56: zitadel.v1.TextQueryMethod
	(*timestamppb.Timestamp)(nil),        // 57: google.protobuf.Timestamp
}
var file_zitadel_user_proto_depIdxs = []int32{
	55, // 0: zitadel.user.v1.User.details:type_name -> zitadel.v1.ObjectDetails
	...
	56, // 18: zitadel.user.v1.UserNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 19: zitadel.user.v1.FirstNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 20: zitadel.user.v1.LastNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 21: zitadel.user.v1.NickNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 22: zitadel.user.v1.DisplayNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 23: zitadel.user.v1.EmailQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 24: zitadel.user.v1.LoginNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	...
	26, // 29: zitadel.user.v1.AuthFactor.u2f:type_name -> zitadel.user.v1.AuthFactorU2F
	5,  // 30: zitadel.user.v1.WebAuthNToken.state:type_name -> zitadel.user.v1.AuthFactorState
	55, // 31: zitadel.user.v1.Membership.details:type_name -> zitadel.v1.ObjectDetails
	32, // 32: zitadel.user.v1.MembershipQuery.org_query:type_name -> zitadel.user.v1.MembershipOrgQuery
	33, // 33: zitadel.user.v1.MembershipQuery.project_query:type_name -> zitadel.user.v1.MembershipProjectQuery
	34, // 34: zitadel.user.v1.MembershipQuery.project_grant_query:type_name -> zitadel.user.v1.MembershipProjectGrantQuery
	35, // 35: zitadel.user.v1.MembershipQuery.iam_query:type_name -> zitadel.user.v1.MembershipIAMQuery
	6,  // 36: zitadel.user.v1.Session.auth_state:type_name -> zitadel.user.v1.SessionState
	55, // 37: zitadel.user.v1.Session.details:type_name -> zitadel.v1.ObjectDetails
	55, // 38: zitadel.user.v1.RefreshToken.details:type_name -> zitadel.v1.ObjectDetails
	57, // 39: zitadel.user.v1.RefreshToken.auth_time:type_name -> google.protobuf.Timestamp
	57, // 40: zitadel.user.v1.RefreshToken.idle_expiration:type_name -> google.protobuf.Timestamp
	57, // 41: zitadel.user.v1.RefreshToken.expiration:type_name -> google.protobuf.Timestamp
	55, // 42: zitadel.user.v1.PersonalAccessToken.details:type_name -> zitadel.v1.ObjectDetails
	57, // 43: zitadel.user.v1.PersonalAccessToken.expiration_date:type_name -> google.protobuf.Timestamp
	55, // 44: zitadel.user.v1.UserGrant.details:type_name -> zitadel.v1.ObjectDetails
	7,  // 45: zitadel.user.v1.UserGrant.state:type_name -> zitadel.user.v1.UserGrantState
	3,  // 46: zitadel.user.v1.UserGrant.user_type:type_name -> zitadel.user.v1.Type
	41, // 47: zitadel.user.v1.UserGrantQuery.project_id_query:type_name -> zitadel.user.v1.UserGrantProjectIDQuery
	42, // 48: zitadel.user.v1.UserGrantQuery.user_id_query:type_name -> zitadel.user.v1.UserGrantUserIDQuery
	43, // 49: zitadel.user.v1.UserGrantQuery.with_granted_query:type_name -> zitadel.user.v1.UserGrantWithGrantedQuery
	44, // 50: zitadel.user.v1.UserGrantQuery.role_key_query:type_name -> zitadel.user.v1.UserGrantRoleKeyQuery
	45, // 51: zitadel.user.v1.UserGrantQuery.project_grant_id_query:type_name -> zitadel.user.v1.UserGrantProjectGrantIDQuery
	46, // 52: zitadel.user.v1.UserGrantQuery.user_name_query:type_name -> zitadel.user.v1.UserGrantUserNameQuery
	47, // 53: zitadel.user.v1.UserGrantQuery.first_name_query:type_name -> zitadel.user.v1.UserGrantFirstNameQuery
	48, // 54: zitadel.user.v1.UserGrantQuery.last_name_query:type_name -> zitadel.user.v1.UserGrantLastNameQuery
	49, // 55: zitadel.user.v1.UserGrantQuery.email_query:type_name -> zitadel.user.v1.UserGrantEmailQuery
	50, // 56: zitadel.user.v1.UserGrantQuery.org_name_query:type_name -> zitadel.user.v1.UserGrantOrgNameQuery
	51, // 57: zitadel.user.v1.UserGrantQuery.org_domain_query:type_name -> zitadel.user.v1.UserGrantOrgDomainQuery
	52, // 58: zitadel.user.v1.UserGrantQuery.project_name_query:type_name -> zitadel.user.v1.UserGrantProjectNameQuery
	53, // 59: zitadel.user.v1.UserGrantQuery.display_name_query:type_name -> zitadel.user.v1.UserGrantDisplayNameQuery
	54, // 60: zitadel.user.v1.UserGrantQuery.user_type_query:type_name -> zitadel.user.v1.UserGrantUserTypeQuery
	56, // 61: zitadel.user.v1.UserGrantRoleKeyQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 62: zitadel.user.v1.UserGrantUserNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 63: zitadel.user.v1.UserGrantFirstNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 64: zitadel.user.v1.UserGrantLastNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 65: zitadel.user.v1.UserGrantEmailQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 66: zitadel.user.v1.UserGrantOrgNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 67: zitadel.user.v1.UserGrantOrgDomainQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 68: zitadel.user.v1.UserGrantProjectNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	56, // 69: zitadel.user.v1.UserGrantDisplayNameQuery.method:type_name -> zitadel.v1.TextQueryMethod
	3,  // 70: zitadel.user.v1.UserGrantUserTypeQuery.type:type_name -> zitadel.user.v1.Type
...
func file_zitadel_user_proto_init() {
	...
	file_zitadel_user_proto_msgTypes[23].OneofWrappers = []interface{}{
	...
	file_zitadel_user_proto_msgTypes[32].OneofWrappers = []interface{}{
