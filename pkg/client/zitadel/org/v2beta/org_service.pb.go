...
import (
	...
	v2beta3 "github.com/zitadel/zitadel-go/v3/pkg/client/zitadel/user/v2beta"
	v2beta2 "github.com/zitadel/zitadel/pkg/grpc/metadata/v2beta"
	v2beta1 "github.com/zitadel/zitadel/pkg/grpc/org/v2beta"
...
type ListOrganizationsRequest struct {
	...
	SortingColumn v2beta1.OrgFieldName `protobuf:"varint,2,opt,name=sorting_column,json=sortingColumn,proto3,enum=zitadel.org.v2beta.OrgFieldName" json:"sorting_column,omitempty"`
	// Define the criteria to query for.
	// repeated ProjectRoleQuery filters = 4;
	Filter []*v2beta1.OrganizationSearchFilter `protobuf:"bytes,3,rep,name=filter,proto3" json:"filter,omitempty"`
}
...
func (x *ListOrganizationsRequest) GetSortingColumn() v2beta1.OrgFieldName {
	if x != nil {
		return x.SortingColumn
	}
	return v2beta1.OrgFieldName(0)
}

func (x *ListOrganizationsRequest) GetFilter() []*v2beta1.OrganizationSearchFilter {
	if x != nil {
		return x.Filter
	}
	return nil
...
type ListOrganizationsResponse struct {
	...
	Organizations []*v2beta1.Organization `protobuf:"bytes,2,rep,name=organizations,proto3" json:"organizations,omitempty"`
}
...
func (x *ListOrganizationsResponse) GetOrganizations() []*v2beta1.Organization {
	if x != nil {
...
type ListOrganizationDomainsRequest struct {
	...
	// Define the criteria to query for.
	Filters []*v2beta1.DomainSearchFilter `protobuf:"bytes,3,rep,name=filters,proto3" json:"filters,omitempty"`
}
...
func (x *ListOrganizationDomainsRequest) GetFilters() []*v2beta1.DomainSearchFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
type ListOrganizationDomainsResponse struct {
	...
	Domains []*v2beta1.Domain `protobuf:"bytes,2,rep,name=domains,proto3" json:"domains,omitempty"`
}
...
func (x *ListOrganizationDomainsResponse) GetDomains() []*v2beta1.Domain {
	if x != nil {
		return x.Domains
	}
	return nil
...
type GenerateOrganizationDomainValidationRequest struct {
	...
	Domain string                       `protobuf:"bytes,2,opt,name=domain,proto3" json:"domain,omitempty"`
	Type   v2beta1.DomainValidationType `protobuf:"varint,3,opt,name=type,proto3,enum=zitadel.org.v2beta.DomainValidationType" json:"type,omitempty"`
}
...
func (x *GenerateOrganizationDomainValidationRequest) GetType() v2beta1.DomainValidationType {
	if x != nil {
		return x.Type
	}
	return v2beta1.DomainValidationType(0)
}
...
type ListOrganizationMetadataRequest struct {
	...
	Pagination *v2beta.PaginationRequest `protobuf:"bytes,2,opt,name=pagination,proto3,oneof" json:"pagination,omitempty"`
	// Define the criteria to query for.
	Filter []*v2beta2.MetadataQuery `protobuf:"bytes,3,rep,name=filter,proto3" json:"filter,omitempty"`
}
...
func (x *ListOrganizationMetadataRequest) GetFilter() []*v2beta2.MetadataQuery {
	if x != nil {
		return x.Filter
	}
	return nil
...
type ListOrganizationMetadataResponse struct {
	...
	Metadata []*v2beta2.Metadata `protobuf:"bytes,2,rep,name=metadata,proto3" json:"metadata,omitempty"`
}
...
func (x *ListOrganizationMetadataResponse) GetMetadata() []*v2beta2.Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *CreateOrganizationRequest_Admin) GetHuman() *v2beta3.AddHumanUserRequest {
...
type CreateOrganizationRequest_Admin_Human struct {
	Human *v2beta3.AddHumanUserRequest `protobuf:"bytes,2,opt,name=human,proto3,oneof"`
}
...
var file_zitadel_org_v2beta_org_service_proto_goTypes = []interface{}{
	...
	(v2beta1.OrgFieldName)(0),                            // 35: zitadel.org.v2beta.OrgFieldName
	(*v2beta1.OrganizationSearchFilter)(nil),             // 36: zitadel.org.v2beta.OrganizationSearchFilter
	(*v2beta.PaginationResponse)(nil),                    // 37: zitadel.filter.v2beta.PaginationResponse
	(*v2beta1.Organization)(nil),                         // 38: zitadel.org.v2beta.Organization
	(*v2beta1.DomainSearchFilter)(nil),                   // 39: zitadel.org.v2beta.DomainSearchFilter
	(*v2beta1.Domain)(nil),                               // 40: zitadel.org.v2beta.Domain
	(v2beta1.DomainValidationType)(0),                    // 41: zitadel.org.v2beta.DomainValidationType
	(*v2beta2.MetadataQuery)(nil),                        // 42: zitadel.metadata.v2beta.MetadataQuery
	(*v2beta2.Metadata)(nil),                             // 43: zitadel.metadata.v2beta.Metadata
	(*v2beta3.AddHumanUserRequest)(nil),                  // 44: zitadel.user.v2beta.AddHumanUserRequest
}
