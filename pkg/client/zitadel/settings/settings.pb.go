...
var file_zitadel_settings_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x2a, 0xc2, 0x02, 0x0a, 0x13, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x47, 0x65,
	...
	0x53, 0x45, 0x43, 0x52, 0x45, 0x54, 0x10, 0x06, 0x2a, 0x85, 0x01, 0x0a, 0x16, 0x53, 0x4d, 0x53,
	0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x74,
...
var file_zitadel_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_zitadel_settings_proto_depIdxs = []int32{
	...
	10, // 1: zitadel.settings.v1.SecretGenerator.details:type_name -> zitadel.v1.ObjectDetails
	11, // 2: zitadel.settings.v1.SecretGenerator.expiry:type_name -> google.protobuf.Duration
	...
	10, // 5: zitadel.settings.v1.SMTPConfig.details:type_name -> zitadel.v1.ObjectDetails
	10, // 6: zitadel.settings.v1.SMSProvider.details:type_name -> zitadel.v1.ObjectDetails
	...
	10, // 9: zitadel.settings.v1.DebugNotificationProvider.details:type_name -> zitadel.v1.ObjectDetails
	10, // 10: zitadel.settings.v1.OIDCSettings.details:type_name -> zitadel.v1.ObjectDetails
	11, // 11: zitadel.settings.v1.OIDCSettings.access_token_lifetime:type_name -> google.protobuf.Duration
	11, // 12: zitadel.settings.v1.OIDCSettings.id_token_lifetime:type_name -> google.protobuf.Duration
	11, // 13: zitadel.settings.v1.OIDCSettings.refresh_token_idle_expiration:type_name -> google.protobuf.Duration
	11, // 14: zitadel.settings.v1.OIDCSettings.refresh_token_expiration:type_name -> google.protobuf.Duration
